...
class PHPWebSocket
{
	...
	public $channel_list     = array();
	public $channel_follow_list= array();
	...
	/*
		$this->wsClients[ integer ClientID ] = array(
			...
			12 => integer  0 unauthorized  1 authorized user 
		)
	...
	*/
	...
	function wsProcessClientHandshake($clientID, &$buffer) {
		...
		//if ($headersKeyed['Origin']!=$this->trusted_host) {print 'blua';return false;}
